...
def check_mass(inventory,new_item):
    tot_mass = new_item['mass']
...
def execute_drop(item_id,current_room,inventory,score):
    """This function takes an item_id as an argument and moves this item from the
    ...
    return current_room,inventory,score
    

def execute_command(command,current_room,inventory,score):
    ...
    if command[0] == "go":
        ...
        if len(command) > 1:
            current_room,inventory,score = execute_drop(command[1],current_room,inventory,score)
        else:
            print("Drop what?")
...
def main():
    ...
    while score < 5:
        ...
        current_room,inventory,score = execute_command(command,current_room,inventory,score)
    input('You won!')
